...
public interface IDataResourceController extends IGenericResourceController<DataResource>{
  ...
  @ResponseBody
  public ResponseEntity handleFileUpload(@ApiParam(value = "The numeric resource identifier.", required = true) @PathVariable(value = "id") final Long id,
  ...
  @ResponseBody
  public ResponseEntity handleFileDownload(@ApiParam(value = "The numeric resource identifier.", required = true) @PathVariable(value = "id") final Long id,
          final Pageable pgbl,
          final WebRequest request,
          final HttpServletResponse response,
          final UriComponentsBuilder uriBuilder);
  ...
  @ResponseBody
  public ResponseEntity patchMetadata(@ApiParam(value = "The numeric resource identifier.", required = true) @PathVariable(value = "id") final Long id,
  ...
  @ResponseBody
  public ResponseEntity deleteContent(@ApiParam(value = "The numeric resource identifier.", required = true) @PathVariable(value = "id") final Long id,
          final WebRequest request,
          final HttpServletResponse response);
}

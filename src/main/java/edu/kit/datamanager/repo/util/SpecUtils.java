...
public class SpecUtils {
    ...
    public static Specification<DataResource> getByExampleSpec(DataResource example, EntityManager em, List<String> sids, PERMISSION permission) {
        ...
        if (example != null) {
            ...
            if (result != null) {
                result = result.and(new ByExampleSpecification(em).
                        byExample(example).
                        and(ResourceTypeSpec.toSpecification(example.getResourceType()))).
                        and(CreatorSpecification.toSpecification(example.getCreators()));
            } else {
                result = new ByExampleSpecification(em).
                        byExample(example).
                        and(ResourceTypeSpec.toSpecification(example.getResourceType())).
                        and(CreatorSpecification.toSpecification(example.getCreators()));
            }
    ...
    /**
     * Check for assigned attributes and if they are supported by search. If
     * not, throw a FeatureNotImplementedException.
     *
     * @param resource The resource to check.
     *
     * @throws FeatureNotImplementedException If at least one unsupported field
     * is assigned at 'resource'.
     */

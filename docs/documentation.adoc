...
|repo.messaging.binding.queue|The queue name collecting all messages of the exchange.|A string uniquely identifying the queue [repoEventQueue]
...
3. handle(BasicMessage message): This method is called 

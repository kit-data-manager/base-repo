...
|============================================================================================================================
|Supported Data Resource Fields|Queried as... 
|publisher|String
|publicationYear|String
|language|String
|version|String
|state|String
|resourceType|String (applies to both child attributes 'typeGeneral' and 'value')
|creators|String (applies to child attributes 'familiyName', 'givenName', and 'affiliations')
|primaryIdentifier|String (applies to child attribute 'value')
|alternateIdentifiers|String (applies to child attribute 'value', 'identifierType' not included, INTERNAL identifier explicitly excluded)
|============================================================================================================================
...
[cols="m,n", options="header"]
|============================================================================================================================
|Supported Content Information Fields|Queried as...
|relativePath|String
|contentUri|String
|mediaType|String
|metadata|String (applies to 'key' and 'value')
|tags|String (exact match via IN expression for all contained elements)
|============================================================================================================================
